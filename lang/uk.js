module.exports = {
    messages: {
        verifyPromptGroup: (username) => `🦘 Привіт, ${username ? `@${username}` : 'друже'}! Щоб заскочити до розмови, будь ласка, пройди невеликий тест: ${process.env.BOT_URL}`,
        ...
        banSpammersComplete: (spammers) => `🦘 Видалено ${spammers} ${spammers === 1 ? 'підозрілий акаунт' : 'підозрілих акаунтів'}. Побачили помилку? Зв'яжіться з нами: ${process.env.BOT_URL}`,
        thanksMessage: "Danke sehr! Приємного спілкування!",
        spamRemoved: "🦘 Неприйнятний контент виявлено та видалено!",
