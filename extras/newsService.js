        ...
        parts: [
          {
            text: `
              ...
              Розбий новини на групи:
                <b>Аналітика</b> 
                [тут ти опишеш про нові вакансії та тренди на ринку праці в ІТ з Австрії, вкажи стистику по затребуваним технологіям. Зараз 2025 рік. Не пиши про зарплати.]
                <b>Стартапи</b> 
                [тут ти опишеш про нові стартапи з Австрії, які зʼявились в новинах минулого тижня. Обов’язково вкажи назви стартапів.]
                
                <b>Дайджест новин</b> 
                [тут ти опишеш про новини з австрійського ІТ за минулий тиждень, навколо ${period}.]
              
              Переконайся, що:
               - Інформація стосується лише останнього тижня. Не включай дані, які стосуються більше ніж 30 днів тому.
               - Тон відповіді збалансований: подавай як позитивні, так і нейтральні чи негативні новини.
              
              Для кожної групи додай до 5 найважливіших подій.
              Розділяй групи подвійним переносом строки
              ...
              Наприкінці додай провокативне коротке запитання, засноване на представлених новинах, щоб викликати обговорення у чаті.

              Закінчи розділои "Джерела":
                публічні джерела, які використовувалися для підготовки новин. 
                Наприклад:
                Джерела:
                   Sifted, Nucamp, Tech.eu, AustriaTech, The Recursive, Vindobona, Revli, EU-Startups, Tech Funding News, DEVjobs.at, Developer Tech.
